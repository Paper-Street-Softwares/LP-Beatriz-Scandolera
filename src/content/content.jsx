...
export const infos = {
  name: "Dra. Beatriz Scandolera",
  email: "contato", // Email desejado pelo cliente
  emailSecundario: "A_Definir", // Email desejado pelo cliente
  domain: "scandoleraadvocacia.com.br", // Sem "www"
  phone: {
    ddd: "19",
    firstPart: "99897", // Apenas os 5 primeiros números (incluindo o 9)
    secondPart: "4306", // Apenas os 4 últimos números
  },
  phoneSecundario: {
    ddd: "A_Definir",
  ...
  texts: {
    ...
    features: {
      ...
      card5: {
        ...
        subtitle: "Atuação em processos e demandas envolvendo órgãos públicos.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card6: {
        ...
        subtitle:
          "Análise preventiva e estratégica para decisões seguras e eficazes.",
        description: (
          <div>
            A_Definir
            <br />
    ...
    blog: {
      ...
      blogLink: "scandoleraadvocacia.wordpress.com", //sem "https://"
    },
    faq: {
